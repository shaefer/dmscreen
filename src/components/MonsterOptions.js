...
const MonsterOptions = () => {
    return (
        <optgroup>
            ...
            <option value="asura_adhukait">Adhukait</option>
            <option>Adlet</option>
            <option value="dragon_chromatic_black_adult">Adult Black Dragon</option>
            <option value="dragon_chromatic_blue_adult">Adult Blue Dragon</option>
            <option value="dragon_metallic_brass_adult">Adult Brass Dragon</option>
            <option value="dragon_primal_brine_adult">Adult Brine Dragon</option>
            <option value="dragon_metallic_bronze_adult">Adult Bronze Dragon</option>
            <option value="dragon_primal_cloud_adult">Adult Cloud Dragon</option>
            <option>Adult Copper Dragon</option>
            <option>Adult Crystal Dragon</option>
            <option>Adult Forest Dragon</option>
            <option>Adult Gold Dragon</option>
            <option>Adult Green Dragon</option>
            <option>Adult Lunar Dragon</option>
            <option>Adult Magma Dragon</option>
            <option>Adult Red Dragon</option>
            <option>Adult Sea Dragon</option>
            <option>Adult Silver Dragon</option>
            <option>Adult Sky Dragon</option>
            <option>Adult Solar Dragon</option>
            <option>Adult Sovereign Dragon</option>
            <option>Adult Time Dragon</option>
            <option>Adult Umbral Dragon</option>
            <option>Adult Underworld Dragon</option>
            <option>Adult Void Dragon</option>
            <option>Adult Vortex Dragon</option>
            <option>Adult White Dragon</option>
            ...
            <option value="div_aghash">Aghash</option>
            <option value="asura_aghasura">Aghasura</option>
            <option>Agyra</option>
            <option>Ahuizotl</option>
            <option>Akata</option>
            <option>Akhlut</option>
            <option>Akvan</option>
            <option>Albino Cave Solifugid</option>
            <option>Allip</option>
            <option>Almiraj</option>
            <option>Alpluachra</option>
            <option>Alraune</option>
            <option>Amoeba Swarm</option>
            <option>Amoeba, Giant</option>
            <option>Amphisbaena</option>
            <option>Ancient Black Dragon</option>
            <option>Ancient Blue Dragon</option>
            <option>Ancient Brass Dragon</option>
            <option>Ancient Brine Dragon</option>
            <option>Ancient Bronze Dragon</option>
            <option>Ancient Cloud Dragon</option>
            <option>Ancient Copper Dragon</option>
            <option>Ancient Crystal Dragon</option>
            <option>Ancient Forest Dragon</option>
            <option>Ancient Gold Dragon</option>
            <option>Ancient Green Dragon</option>
            <option>Ancient Lunar Dragon</option>
            <option>Ancient Magma Dragon</option>
            <option>Ancient Red Dragon</option>
            <option>Ancient Sea Dragon</option>
            <option>Ancient Silver Dragon</option>
            <option>Ancient Sky Dragon</option>
            <option>Ancient Solar Dragon</option>
            <option>Ancient Sovereign Dragon</option>
            <option>Ancient Time Dragon</option>
            <option>Ancient Umbral Dragon</option>
            <option>Ancient Underworld Dragon</option>
            <option>Ancient Void Dragon</option>
            ...
            <option value="ant_giant">Ant, (Giant)</option>
            <option>Ant, Army, Swarm</option>
            ...
            <option>Bezravnis</option>
            <option>Bhole</option>
            <option>Bhuta</option>
            <option>Blindheim</option>
            <option>Blink Dog</option>
            <option>Blood Golem</option>
            ...
            <option>Bone Golem</option>
            <option>Brain Ooze</option>
            <option>Brass Golem</option>
            <option>Brethedan</option>
            <option>Broken Soul Lillend</option>
            ...
            <option>Derro</option>
            <option>Desert Drake</option>
            <option>Desert Giant</option>
            <option>Destrachan</option>
            <option>Devil, Accuser (Zebub)</option>
            <option>Devil, Barbed</option>
            <option>Devil, Belier (Bdellavritra)</option>
            <option>Devil, Bone</option>
            <option>Devil, Erinyes</option>
            <option>Devil, Handmaiden</option>
            <option>Devil, Handmaiden (Gylou)</option>
            <option>Devil, Horned</option>
            <option>Devil, Ice</option>
            <option>Devil, Immolation (Puragaus)</option>
            <option>Devil, Imp</option>
            <option>Devil, Lemure</option>
            <option>Devil, Pit Fiend</option>
            <option>Devilbound Sorcerer</option>
            <option>Devilfish</option>
            <option>Devourer</option>
            <option>Dhampir</option>
            <option>Dimetrodon</option>
            <option>Dimorphodon</option>
            <option>Dinosaurus, Allosaurus</option>
            <option>Dinosaurus, Ankylosaurus</option>
            <option>Dinosaurus, Brachiosaurus</option>
            <option>Dinosaurus, Compsognathus</option>
            <option>Dinosaurus, Deinonychus</option>
            <option>Dinosaurus, Elasmosaurus</option>
            <option>Dinosaurus, Parasaurolophus</option>
            <option>Dinosaurus, Pteranodon</option>
            <option>Dinosaurus, Stegosaurus</option>
            <option>Dinosaurus, Triceratops</option>
            <option>Dinosaurus, Tylosaurus</option>
            <option>Dinosaurus, Tyrannosaurus</option>
            <option>Diplodocus</option>
            <option>Dire Ape</option>
            <option>Dire Corby</option>
            <option>Dire Lion</option>
            <option>Dire Lion</option>
            <option>Dire Weasel</option>
            <option>Dire Wolverine</option>
            <option>Disenchanter</option>
            <option>Divine Guardian Hydra</option>
            <option>Dodo</option>
            <option>Dog, Common</option>
            <option>Dog, Hyena</option>
            <option>Dog, Hyena, Dire</option>
            <option>Dog, Riding</option>
            <option>Dog, Wolf</option>
            <option>Dog, Wolf, Dire</option>
            <option>Dolphin, Bottlenose</option>
            <option>Dolphin, Orca (Killer Whale)</option>
            ...
            <option>Dragonfly, (Giant)</option>
            <option>Dragonfly, Nymph (Giant)</option>
            ...
            <option>Drow, Common</option>
            <option>Drowning Devil</option>
            <option>Dryad</option>
            ...
            <option>Ectoplasmic Human</option>
            <option>Eel, Electric</option>
            <option>Eel, Moray (Giant)</option>
            <option>Einherji</option>
            <option>Elder Air Elemental</option>
            <option>Elder Earth Elemental</option>
            <option>Elder Fire Elemental</option>
            <option>Elder Ice Elemental</option>
            <option>Elder Lightning Elemental</option>
            <option>Elder Magma Elemental</option>
            <option>Elder Mud Elemental</option>
            <option>Elder Thing</option>
            <option>Elder Water Elemental</option>
            <option>Elephant, Common</option>
            <option>Elephant, Mastodon</option>
            <option>Elk</option>
            <option>Elohim</option>
            <option>Elysian Titan</option>
            <option>Emperor Cobra</option>
            <option>Emperor Walrus</option>
            <option>Eremite</option>
            ...
            <option>Ghawwas</option>
            <option>Gholdako</option>
            <option>Ghonhatine</option>
            <option>Ghorazagh</option>
            <option>Ghost</option>
            <option>Ghost Scorpion</option>
            <option>Ghoul</option>
            <option>Ghul</option>
            <option>Giant Adult Ant Lion</option>
            <option>Giant Anaconda</option>
            <option>Giant Ant Lion</option>
            <option>Giant Chameleon</option>
            <option>Giant Crab Spider</option>
            <option>Giant Emperor Scorpion</option>
            <option>Giant Flea</option>
            <option>Giant Gecko</option>
            <option>Giant Locust</option>
            <option>Giant Maggot</option>
            <option>Giant Mosquito</option>
            <option>Giant Owl</option>
            <option>Giant Phantom Armor</option>
            <option>Giant Porcupine</option>
            <option>Giant Rot Grub</option>
            <option>Giant Sea Anemone</option>
            <option>Giant Seahorse</option>
            <option>Giant Skunk</option>
            <option>Giant Snapping Turtle</option>
            <option>Giant Solifugid</option>
            <option>Giant Squid</option>
            <option>Giant Stag Beetle</option>
            <option>Giant Tarantula</option>
            <option>Giant Tick</option>
            <option>Giant Toad</option>
            <option>Giant Tortoise</option>
            <option>Giant Vulture</option>
            <option>Giant Water Strider</option>
            <option>Giant Weasel</option>
            ...
            <option>Girallon, Common</option>
            <option>Girtablilu</option>
            <option>Glacier Toad</option>
            ...
            <option>Goliath Spider</option>
            <option>Gorgon</option>
            <option>Gorilla</option>
            <option>Gorynych</option>
            <option>Gourd Leshy</option>
            <option>Graeae</option>
            <option>Graveknight</option>
            <option>Graven Guardian</option>
            <option>Gray Render</option>
            <option>Great Cyclops</option>
            <option>Great Horned Owl</option>
            <option>Great White Shark</option>
            <option>Great White Whale</option>
            <option>Greater Air Elemental</option>
            <option>Greater Earth Elemental</option>
            <option>Greater Fire Elemental</option>
            <option>Greater Ice Elemental</option>
            <option>Greater Lightning Elemental</option>
            <option>Greater Magma Elemental</option>
            <option>Greater Mud Elemental</option>
            <option>Greater Water Elemental</option>
            <option>Greensting Scorpion</option>
            ...
            <option>Horse</option>
            <option>Host Devil</option>
            <option>Hound of Tindalos</option>
            <option>Howler</option>
            <option>Huecuva</option>
            <option>Huge Air Elemental</option>
            <option>Huge Earth Elemental</option>
            <option>Huge Fire Elemental</option>
            <option>Huge Ice Elemental</option>
            <option>Huge Lightning Elemental</option>
            <option>Huge Magma Elemental</option>
            <option>Huge Mud Elemental</option>
            <option>Huge Water Elemental</option>
            <option>Huldra</option>
            <option>Human Juju Zombie</option>
            ...
            <option>Jelly, Ochre</option>
            <option>Jellyfish, (Giant)</option>
            <option>Jellyfish, Swarm</option>
            <option>Jiang-shi</option>
            <option>Jinmenju</option>
            <option>Jinushigami</option>
            <option>Jorogumo</option>
            <option>Jotund Troll</option>
            <option>Jubjub Bird</option>
            <option>Juggernaut</option>
            <option>Julunggali</option>
            <option>Jungle Giant</option>
            <option>Junk Golem</option>
            <option>Juvenile Rukh</option>
            <option>Juvenile Seps</option>
            <option>Jyoti</option>
            ...
            <option>Killer Seahorse</option>
            <option>Kirin</option>
            <option>Kitsune</option>
            <option>Kobold</option>
            <option>Kodama</option>
            <option>Kongamato</option>
            <option>Korada</option>
            ...
            <option>Large Air Elemental</option>
            <option>Large Earth Elemental</option>
            <option>Large Fire Elemental</option>
            <option>Large Ice Elemental</option>
            <option>Large Lightning Elemental</option>
            <option>Large Magma Elemental</option>
            <option>Large Mud Elemental</option>
            <option>Large Spriggan</option>
            <option>Large Water Elemental</option>
            <option>Lava Drake</option>
            <option>Leaf Leshy</option>
            <option>Leaf Ray</option>
            <option>Leanan Sidhe</option>
            <option>Leech, (Giant)</option>
            <option>Leech, Swarm</option>
            <option>Legion Archon</option>
            ...
            <option>Lizard, Common</option>
            <option>Lizard, Frilled (Giant)</option>
            ...
            <option>Marai</option>
            <option>Medium Air Elemental</option>
            <option>Medium Earth Elemental</option>
            <option>Medium Fire Elemental</option>
            <option>Medium Ice Elemental</option>
            <option>Medium Lightning Elemental</option>
            <option>Medium Magma Elemental</option>
            <option>Medium Mud Elemental</option>
            <option>Medium Water Elemental</option>
            ...
            <option>Mist Drake</option>
            <option>Mite</option>
            <option>Mobogo</option>
            <option>Mogaru</option>
            <option>Mohrg</option>
            <option>Mold, Slime</option>
            <option>Monaciello</option>
            <option>Mongrelman</option>
            <option>Monkey </option>
            <option>Moon-beast</option>
            <option>Moonflower</option>
            <option>Morlock</option>
            <option>Morrigna</option>
            <option>Mosquito Swarm</option>
            <option>Moss Troll</option>
            <option>Mothman</option>
            <option>Mu Spore</option>
            <option>Mudlord</option>
            <option>Mummified Gynosphinx</option>
            <option>Mummy</option>
            ...
            <option>Nightmare Ettercap</option>
            ...
            <option>Nycar</option>
            <option>Nymph</option>
            <option>Nymph Water Strider</option>
            <option>Ocean Giant</option>
            <option>Oceanid</option>
            <option>Octopus</option>
            <option>Octopus, (Giant)</option>
            <option>Ogre</option>
            <option>Ogre Spider</option>
            <option>Ogrekin (Half-Ogre)</option>
            <option>Oma</option>
            <option>Oni, Ogre Mage</option>
            <option>Ooze, Gray</option>
            <option>Orc</option>
            <option>Oread</option>
            <option>Ostiarius</option>
            <option>Otter</option>
            ...
            <option>Primate, Monkey, Swarm</option>
            ...
            <option>Raktavarna</option>
            <option>Rast</option>
            <option>Rat King</option>
            <option>Rat, Common</option>
            <option>Rat, Dire</option>
            <option>Rat, Swarm</option>
            <option>Ratfolk</option>
            <option>Ratling</option>
            <option>Raven</option>
            <option>Red Wyrm Ravener</option>
            ...
            <option>Rift Drake</option>
            <option>River Drake</option>
            <option>River Giant</option>
            <option>Roc</option>
            <option>Rokurokubi</option>
            <option>Roper</option>
            <option>Rot Grub Swarm</option>
            <option>Royal Naga</option>
            <option>Rukh</option>
            ...
            <option>Sapphire Jellyfish</option>
            <option>Sard</option>
            ...
            <option>Shadow Drake</option>
            <option>Shadow Mastiff</option>
            <option>Shadow Roper</option>
            <option>Shadow, Greater</option>
            <option>Shae</option>
            <option>Shaggy Demodand</option>
            <option>Shambling Mound</option>
            <option>Shantak</option>
            <option>Shard Slag</option>
            <option>Shark, Common</option>
            <option>Shark, Dire (Megalodon)</option>
            <option>Shark-Eating Crab</option>
            <option>Shedu</option>
            <option>Shikigami</option>
            <option>Shinigami</option>
            <option>Shining Child</option>
            <option>Shipwrecker Crab</option>
            <option>Shira</option>
            ...
            <option>Skum</option>
            <option>Skunk</option>
            <option>Slag Giant</option>
            <option>Sleipnir</option>
            <option>Slimy Demodand</option>
            <option>Slithering Tracker</option>
            <option>Sloth</option>
            <option>Slug, (Giant)</option>
            <option>Slurk</option>
            <option>Small Air Elemental</option>
            <option>Small Earth Elemental</option>
            <option>Small Fire Elemental</option>
            <option>Small Ice Elemental</option>
            <option>Small Lightning Elemental</option>
            <option>Small Magma Elemental</option>
            <option>Small Mud Elemental</option>
            <option>Small Water Elemental</option>
            <option>Snake Swarm</option>
            <option>Snake, Constrictor</option>
            <option>Snake, Venomous</option>
            <option>Snallygaster</option>
            <option>Snapping Turtle</option>
            ...
            <option>Spider, Black Widow (Giant)</option>
            <option>Spider, Swarm</option>
            <option>Spinosaurus</option>
            <option>Spire Drake</option>
            <option>Spirit Oni</option>
            ...
            <option>Thunder Behemoth</option>
            <option>Thunderbird</option>
            <option>Thylacine</option>
            <option>Tiberolith</option>
            <option>Tick Swarm</option>
            ...
            <option>Tor Linnorm</option>
            <option>Toshigami</option>
            <option>Totenmaske</option>
            <option>Trapper</option>
            <option>Treant</option>
            <option>Tripurasura</option>
            ...
            <option>Unfettered Eidolon</option>
            <option>Unicorn</option>
            <option>Upasunda</option>
            ...
            <option>Woolly Rhinoceros</option>
            <option>Worg</option>
            ...
            <option>Yamaraj</option>
            <option>Yaoguai</option>
            <option>Yellow Musk Creeper</option>
            <option>Yeth Hound</option>
            <option>Yeti</option>
            <option>Yithian</option>
            <option>Young Black Dragon</option>
            <option>Young Blue Dragon</option>
            <option>Young Brass Dragon</option>
            <option>Young Brine Dragon</option>
            <option>Young Bronze Dragon</option>
            <option>Young Cloud Dragon</option>
            <option>Young Copper Dragon</option>
            <option>Young Crystal Dragon</option>
            <option>Young Forest Dragon</option>
            <option>Young Gold Dragon</option>
            <option>Young Green Dragon</option>
            <option>Young Lunar Dragon</option>
            <option>Young Magma Dragon</option>
            <option>Young Red Dragon</option>
            <option>Young Sea Dragon</option>
            <option>Young Silver Dragon</option>
            <option>Young Sky Dragon</option>
            <option>Young Solar Dragon</option>
            <option>Young Sovereign Dragon</option>
            <option>Young Time Dragon</option>
            <option>Young Umbral Dragon</option>
            <option>Young Underworld Dragon</option>
            <option>Young Void Dragon</option>
            <option>Young Vortex Dragon</option>
            <option>Young White Dragon</option>
