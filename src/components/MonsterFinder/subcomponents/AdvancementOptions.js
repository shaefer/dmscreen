    ...
    render() {
        ...
        return (
            <MuiThemeProvider theme={theme}>
                ...
                <ClassLevelSelect hideLabel classes={["Barbarian", "Bard", "Cleric", "Druid", "Fighter", "Paladin"]} onChange={(e) => this.classLevelsChanged(e)} ref={this.classLevelSelectRef} defaultClasses={this.state.defaultClasses} key={this.state.defaultClasses}/>
            </MuiThemeProvider>
        );
    }
}
