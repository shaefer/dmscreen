...
const MonsterOptions = [
    ...
    <option value="dragon_metallic_copper_adult">Adult Copper Dragon</option>,
    <option value="dragon_primal_crystal_adult">Adult Crystal Dragon</option>,
    <option value="dragon_primal_forest_adult">Adult Forest Dragon</option>,
    <option value="dragon_metallic_gold_adult">Adult Gold Dragon</option>,
    <option value="dragon_chromatic_green_adult">Adult Green Dragon</option>,
    <option value="dragon_primal_lunar_adult">Adult Lunar Dragon</option>,
    <option value="dragon_primal_magma_adult">Adult Magma Dragon</option>,
    ...
    <option value="sphinx_androsphinx">Androsphinx</option>,
    ...
    <option value="swarm_army_ant">Ant, Army, Swarm</option>,
    ...
    <option value="megafauna_archelon">Archelon</option>,
    ...
    <option value="kyton_augur">Augur</option>,
    ...
    <option>Baku</option>,
    <option value="megafauna_baluchitherium">Baluchitherium</option>,
