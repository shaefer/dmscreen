...
//Keep an eye on this if this is too brittle as I make changes...but generally I should probably be more aware of changes that are affecting required inputs or overall changes to the output.
it('general input and out for regression', () => {
    //const advancedBehir = advanceMonster(Behir, {str:0});
    //console.log(JSON.stringify(advancedBehir))
    /*
