...
it('add resistance if none exists', () => {
    ...
    const advancedBehir = advanceMonster(Behir, {templates:[Fiendish]});
...
it ('change resistance if one exists', () => {
    ...
    const advancedAngel = advanceMonster(AngelAstralDeva, {templates:[Fiendish]});
...
it ('add sr newCr + 5 ', () => {
    ...
    const advancedCreature = advanceMonster(Behir, {templates:[Fiendish]});
...
it ('update Darkvision when lower than 60ft.', () => {
    ...
    const advancedCreature = advanceMonster(ProteanVoidWorm, {templates:[Fiendish]});
...
it ('add Darkvision when not exists', () => {
    ...
    const advancedCreature = advanceMonster(Allosaurus, {templates:[Fiendish]});
